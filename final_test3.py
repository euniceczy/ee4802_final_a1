...
def my_prediction(encoded_month,encoded_flat_type,encoded_storey_range,encoded_town,encoded_flat_model,selected_fa,selected_lease):
    ...
    data = pd.read_csv('https://raw.githubusercontent.com/euniceczy/ee4802_final_a1/master/resale_flat_prices_based_on_registration_date_from_jan_2017_onwards.csv')
